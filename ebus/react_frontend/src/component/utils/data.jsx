...
import roma from '../../images/team-photos/roma.png'
import ira from '../../images/team-photos/ira.png'
import kar from '../../images/team-photos/kar.png'
import vlad from '../../images/team-photos/vlad.png'
import max from '../../images/team-photos/max.png'
...
export const partners = [
  {
    ...
    logo: nuwee_logo,
    shortName: "NUWEE",
    link: "https://nuwm.edu.ua/university"
  },
  {
    id: 2,
    name: "MaRKIV: Talented website developers in a creative community",
    logo: markiv_logo,
    shortName: "MaRKIV",
    link: "/markiv-team"
  },
...
export const team = [
  {id: 1, name: "Роман", work: "Back-end розробник", photo: roma},
  {id: 2, name: "Ірина", work: "Front-end розробник", photo: ira},
  {id: 3, name: "Карина", work: "Дизайнер", photo: kar},
  {id: 4, name: "Влад", work: "Дизайнер", photo: vlad},
  {id: 5, name: "Максим", work: "Юрист", photo: max},
];
